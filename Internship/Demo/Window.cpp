...
namespace Internship::Demo
{
    ...
    {
        glm::vec3 direction = Internship::Directions::ZERO;
        ...
        if (glfwGetKey(_window, GLFW_KEY_Q) == GLFW_PRESS)
            direction += Internship::Directions::UP;
    ...
    void Window::load(
            Internship::Rendering::OpenGL::Mesh *mesh,
            Internship::Rendering::OpenGL::Shader *shader,
            const Internship::Rendering::Camera &camera)
    {
        _mesh = mesh;
        _shader = shader;
        _camera = camera;
